...
<html>
  ...
  <body>
    <%
      ...
      Jugador.guardarJugador(Integer.valueOf(request.getParameter("idJugador")), request.getParameter("nombreJugador"), request.getParameter("emailJugador"), request.getParameter("nickJugador"), s);
