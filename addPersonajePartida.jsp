  ...
  <body>
    <%
      ...
      request.setCharacterEncoding("UTF-8");
       ...
       // Añadimos el personaje a la partida
      Personaje.entrarPartida(Integer.valueOf(request.getParameter("idPartida")),Integer.valueOf(request.getParameter("personajes")), s);
      //out.println();
